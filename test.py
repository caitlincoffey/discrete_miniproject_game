...
class Graph(object):
    ...
    def add(self, node):
        ...
        while not added:
            # in order: outerbr, 2ndbr, 2ndbc, 1stbc (cycle clockwise), 2ndcr (cycle counter clockwise),
            # 3rdbl (cycle clockwise)

            # TODO add more :)
            positions = [(425, 400), (375, 350), (425, 300), (450, 250), (300, 125), (300,50), (75, 200), (475, 100), (500, 200), (150, 400)]
